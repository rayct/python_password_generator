...
b9 = ttk.Button(root, text="Solid Button", bootstyle=SUCCESS)
b9.pack(side=LEFT, padx=5, pady=10)

b10 = ttk.Button(root, text="Outline Button", bootstyle=(SUCCESS, OUTLINE))
